...
class HexagonProgressBarFactory {
	...
	private List<List<Double>> generateCoordinateOfInnerProgressBar() {
		...
		coordinate.add(Arrays.asList(SQRT3 / 2 * baseEdgeLen, 0 + halfWidth));
		coordinate.add(Arrays.asList(SQRT3 * baseEdgeLen - SQRT3 / 2 * halfWidth, baseEdgeLen / 2 + halfWidth / 2));
		coordinate.add(Arrays.asList(SQRT3 * baseEdgeLen - SQRT3 / 2 * halfWidth, baseEdgeLen * 1.5 - halfWidth / 2));
		coordinate.add(Arrays.asList(SQRT3 / 2 * baseEdgeLen, baseEdgeLen * 2 - halfWidth));
		coordinate.add(Arrays.asList(SQRT3 / 2 * halfWidth, 1.5 * baseEdgeLen - halfWidth / 2));
		coordinate.add(Arrays.asList(SQRT3 / 2 * halfWidth, 0.5 * baseEdgeLen + halfWidth / 2));
	...
	void print() {
		String baseCoordinate = format(generateCoordinateOfBase());
	...
	public static void main(String[] args) {
		HexagonProgressBarFactory svg = new HexagonProgressBarFactory(30, 4, 20);
		svg.print();
	}
}